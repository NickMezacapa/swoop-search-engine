...
const HomeSearchFilters = () => {
  ...
  return (
    <div className='hidden h-[200px] mt-4 md:flex flex-wrap overflow-x-scroll gap-x-6 [mask-image:linear-gradient(to_bottom,white_60%,transparent)] text-[#eae8ed] leading-[1.08349] tracking-[-0.003em] text-3xl'>
