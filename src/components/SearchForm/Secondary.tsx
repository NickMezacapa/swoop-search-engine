...
const SearchFormSecondary = () => {
  ...
  return (
    <form onSubmit={handleSearchFormSubmit} className='flex flex-grow border border-[#a1a1a6c3] rounded-full shadow-2xl max-w-3xl items-center px-6 py-3 ml-10 mr-5 text-[#eee] bg-[#E8E7E3] dark:bg-[#303032]'>
